...
public class TopicosController {
	...
	@GetMapping
	@Cacheable (value = "listaDeTopicos") //Pra cada variação no parâmetro na consulta, a API consulta o BD, caso contrário, guarda em cache
//	@ResponseBody
	public Page<TopicoDto> lista(@RequestParam(required = false) String nomeCurso,
			@PageableDefault(sort = "id", direction = Direction.ASC, page = 0, size = 10) Pageable paginacao) {

		/*
		 * // Classe Spring Data que realiza a paginação (DE FORMA MANUAL) Pageable
